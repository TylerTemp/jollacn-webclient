...
export default({startPage=1, limit=24}) => {
  // const defaultLimit = 10;
  const [apiState, setApiState] = useState({loading: true, error: null, offset: (startPage-1)*limit, limit, total: 0, tieList: []});
  ...
  const fetchTieList = offset => {
    ...
    request(reqUri)
      ...
      .then(result => {
        ...
        setApiState({...apiState, total: nowTotal, offset, limit: serverLimit, loading: false, error: null, tieList});
      })
